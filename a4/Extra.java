...
public class Extra {
     ...
     */     
    public static StringList toPrefix(String[]array){
        StringStack stack = new StringStackRefBased();
     ...
     */ 
    public static String evaluatePrefix(StringList list){
        String result=null;
        int frontNumber=0;
        int backNumber=0;
    ...
    */
    ...
    //convert infix to prefix    
        StringList list=toPrefix(element);
        
    //evaluate postfix expression 
        result=evaluatePrefix(list);
